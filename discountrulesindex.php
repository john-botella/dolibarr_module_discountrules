...
/**
 *	\file       htdocs/discountrules/template/discountrulesindex.php
 *	\ingroup    discountrules
 *	\brief      Home page of discountrules top menu
 */
...
if (! $user->rights->discountrules->read) accessforbidden();
...
llxHeader("",$langs->trans("discountrulesArea"));

print load_fiche_titre($langs->trans("discountrulesArea"),'','discountrules.png@discountrules');
...
// Draft MyObject
if (! empty($conf->discountrules->enabled) && $user->rights->discountrules->read)
{
	$langs->load("orders");
