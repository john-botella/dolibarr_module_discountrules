...
/**
 * \file    test/functional/discountrulesFunctionalTest.php
...
/**
 * Class discountrulesFunctionalTest
 *
 ...
 *
 * @package Testdiscountrules
 */
class discountrulesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
...
//        )
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('moddiscountrules')->click();
		} else {
			// Disable the module
			$this->byHref('moddiscountrules')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/discountrules/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('discountrules/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/discountrules/admin/about.php');
		$this->authenticate();
		return $this->assertContains('discountrules/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('discountruleswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_moddiscountrules_discountrulesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_moddiscountrules_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
